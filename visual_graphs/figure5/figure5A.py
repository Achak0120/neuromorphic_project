"""
Figure 5A — Feature-Space Scatter: Temperature vs. Humidity by Class
...
def plot_temp_vs_humidity(save_path: str = f"{OUT}/figure_5a_temp_vs_humidity.png"):
    plt.rcParams.update({
    ...
    ax.scatter(nofire["Temp"], nofire["Humidity"],
               c=BLUE, alpha=0.20, s=12, edgecolors="none", label="No Fire")
    ax.scatter(fire["Temp"],   fire["Humidity"],
    ...
    ax.set_title(
        "Feature Space: Temperature vs. Humidity\n"
